...
import '../controller/update-services.dart';
import '../model/product.dart';

class UpdateScreen extends StatefulWidget {
  ProductModel productModel;
   UpdateScreen({super.key,required this.productModel});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Update',style: TextStyle(color: AppConstant.appTextColor,fontFamily: AppConstant.appFontFamily),),
      ),
